...
<body class="bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 min-h-screen" x-data="productsManager()">
                ...
                <form method="GET" class="space-y-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                        ...
                        <div class="lg:col-span-2">
                            <label for="search" class="block text-sm font-medium text-gray-700 mb-2">Recherche
                                globale</label>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                        <!-- Prix -->
                        <div>
                            <label for="price_min" class="block text-sm font-medium text-gray-700 mb-2">Prix
                                minimum</label>
                            <input type="number" name="price_min" id="price_min" step="0.01" min="0"
                                value="<?php echo htmlspecialchars($price_min); ?>" placeholder="0.00"
                                class="w-full px-4 py-3 border border-gray-300 rounded-xl shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200">
                        </div>
                        <div>
                            <label for="price_max" class="block text-sm font-medium text-gray-700 mb-2">Prix
                                maximum</label>
                            <input type="number" name="price_max" id="price_max" step="0.01" min="0"
                                value="<?php echo htmlspecialchars($price_max); ?>" placeholder="999.99"
                                class="w-full px-4 py-3 border border-gray-300 rounded-xl shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200">
                        </div>

                        <!-- Stock -->
                        <div>
                            <label for="stock_min" class="block text-sm font-medium text-gray-700 mb-2">Stock
                                minimum</label>
                            <input type="number" name="stock_min" id="stock_min" min="0"
                                value="<?php echo htmlspecialchars($stock_min); ?>" placeholder="0"
                                class="w-full px-4 py-3 border border-gray-300 rounded-xl shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200">
                        </div>
                        <div>
                            <label for="stock_max" class="block text-sm font-medium text-gray-700 mb-2">Stock
                                maximum</label>
                            <input type="number" name="stock_max" id="stock_max" min="0"
                                value="<?php echo htmlspecialchars($stock_max); ?>" placeholder="999"
                                class="w-full px-4 py-3 border border-gray-300 rounded-xl shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200">
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <!-- Dates -->
                        <div>
                            <label for="date_from" class="block text-sm font-medium text-gray-700 mb-2">Date de création
                                - Du</label>
                        ...
                        <tbody class="bg-white/30 divide-y divide-gray-200">
                            <?php foreach ($products as $product): ?>
                                <tr class="hover:bg-white/50 animate-fade-in transition-all duration-200">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span
                                            class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium <?php echo $product['stock_quantity'] > 10 ? 'bg-green-100 text-green-800 border border-green-200' : ($product['stock_quantity'] > 0 ? 'bg-yellow-100 text-yellow-800 border border-yellow-200' : 'bg-red-100 text-red-800 border border-red-200'); ?>">
                                            <?php echo $product['stock_quantity']; ?>
                                            unité<?php echo $product['stock_quantity'] > 1 ? 's' : ''; ?>
                                        </span>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span
                                            class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium <?php echo $product['is_active'] ? 'bg-green-100 text-green-800 border border-green-200' : 'bg-red-100 text-red-800 border border-red-200'; ?>">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        <div class="flex justify-end space-x-2">
                                            ...
                                            <button
                                                @click="openDeleteModal('<?php echo $product['id']; ?>', '<?php echo htmlspecialchars($product['name']); ?>')"
                        ...
                        <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                            <div>
                                <p class="text-sm text-gray-700">
                                    Affichage de <span class="font-medium"><?php echo ($offset + 1); ?></span> à <span
                                        class="font-medium"><?php echo min($offset + $limit, $totalProducts); ?></span>
                ...
                <div @submit.prevent="submitForm()">
                    <div class="px-6 pt-6 pb-4">
                        <div class="flex items-center mb-6">
                            <div
                                class="w-12 h-12 bg-gradient-to-r from-blue-500 to-indigo-600 rounded-xl flex items-center justify-center shadow-lg mr-4">
                            ...
                            <div>
                                <h3 class="text-2xl font-bold bg-gradient-to-r from-gray-800 to-gray-600 bg-clip-text text-transparent"
                                    x-text="isEditing ? 'Modifier le produit' : 'Nouveau produit'"></h3>
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                            ...
                            <div class="space-y-6">
                                ...
                                <div class="relative">
                                    ...
                                    <label for="product-name"
                                        class="floating-label absolute left-4 text-gray-600 font-medium pointer-events-none">
                                        Nom du produit *
                                    </label>
                                </div>
                                ...
                                <div class="relative">
                                    ...
                                    <label for="product-category"
                                        class="absolute left-4 -top-2 text-sm text-gray-600 font-medium bg-white px-2">
                                        Catégorie *
                                    </label>
                                </div>
                                ...
                                <!-- Prix -->
                                <div class="relative">
                                    <input type="number" id="product-price" x-model="formData.price" step="0.01" min="0"
                                ...
                                <!-- Stock -->
                                <div class="relative">
                                    <input type="number" id="product-stock" x-model="formData.stock_quantity" min="0"
                                        required placeholder=" "
                                        class="peer w-full px-4 py-4 border-2 border-gray-300 rounded-xl shadow-sm focus:outline-none focus:ring-0 focus:border-blue-500 transition-all duration-200 form-input">
                            ...
                            <div class="space-y-6">
                                <!-- Images du produit -->
                                <div class="relative">
                                    <label class="block text-sm font-semibold text-gray-700 mb-3">Images du
                                        produit</label>
                                    ...
                                    <div x-show="selectedImages.length > 0 || (isEditing && formData.images)"
                                        class="mt-4">
                                        <div x-data="{ imageKey: 0 }" :key="imageKey"
                                            class="grid grid-cols-2 sm:grid-cols-3 gap-4">
                                            <!-- Images existantes en mode édition -->
                                            <template x-if="isEditing && formData.images">
                                                <template x-for="(image, index) in getImagesArray(formData.images)"
                                                    :key="index">
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="flex space-x-1">
                                                                <button type="button" @click="setMainImage(index)"
                                                                    x-show="!image.is_main" :disabled="loading"
    ...
    <div x-show="showViewModal" x-transition:enter="transition ease-out duration-300"
        ...
        <div class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div
                class="inline-block align-bottom glass-effect rounded-2xl text-left overflow-hidden shadow-2xl transform transition-all sm:my-8 sm:align-middle sm:max-w-4xl sm:w-full">
                <div class="px-6 pt-6 pb-4">
                    <div class="flex items-center mb-6">
                        <div
                            class="w-12 h-12 bg-gradient-to-r from-blue-500 to-indigo-600 rounded-xl flex items-center justify-center shadow-lg mr-4">
                    ...
                    <div x-show="viewData" class="space-y-6">
                        ...
                        <template
                            x-if="viewData && viewData.images && viewData.images !== 'null' && viewData.images !== ''">
                                ...
                                <div x-data="{ 
                                    ...
                                    <div class="relative" x-show="imagesList.length > 0">
                                        <template x-for="(image, index) in imagesList" :key="index">
                                            <img x-show="index === currentImageIndex" :src="'../'+ image.path"
                                        ...
                                        <template x-if="imagesList.length > 1">
                                            <div>
                                                <button
                                                    @click="currentImageIndex = currentImageIndex > 0 ? currentImageIndex - 1 : imagesList.length - 1"
                                                ...
                                                <button
                                                    @click="currentImageIndex = currentImageIndex < imagesList.length - 1 ? currentImageIndex + 1 : 0"
                            ...
                            <div class="space-y-6">
                                <div class="glass-effect p-4 rounded-xl">
                                    ...
                                    <p class="text-lg text-gray-900 font-medium"
                                        x-text="viewData?.name || 'Non défini'"></p>
                                </div>
                                ...
                                <div class="glass-effect p-4 rounded-xl">
                                    ...
                                    <span
                                        class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-gradient-to-r from-blue-100 to-indigo-100 text-blue-800 border border-blue-200"
                                        x-text="viewData?.category_name || 'Sans catégorie'"></span>
                                </div>
                            </div>
                            ...
                            <div class="space-y-6">
                                <div class="glass-effect p-4 rounded-xl">
                                    ...
                                    <p class="text-2xl text-gray-900 font-bold"
                                        x-text="viewData?.price ? parseFloat(viewData.price).toFixed(2) + ' FCFA' : 'Non défini'">
                                    </p>
                                </div>
                                ...
                                <div class="glass-effect p-4 rounded-xl">
                                    ...
                                    <div class="flex items-center space-x-3">
                                        <p class="text-xl text-gray-900 font-semibold"
                                            x-text="viewData?.stock_quantity || 0"></p>
                                        <span class="text-gray-600">unité<span
                                                x-text="(viewData?.stock_quantity || 0) > 1 ? 's' : ''"></span></span>
                                    </div>
                                </div>
                                ...
                                <div class="glass-effect p-4 rounded-xl">
                                    <label class="block text-sm font-semibold text-gray-700 mb-2">Date de
                                        création</label>
                                    <p class="text-gray-600"
                                        x-text="viewData?.created_at ? new Date(viewData.created_at).toLocaleDateString('fr-FR') : 'Non définie'">
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                            ...
                            <div class="mt-2">
                                <p class="text-sm text-gray-500">
                                    Êtes-vous sûr de vouloir supprimer le produit "<span x-text="deleteItem.name"
    ...
    <div x-show="notification.show" x-transition:enter="transition ease-out duration-300"
        ...
        style="display: none;">
        <div class="glass-effect rounded-xl p-4 shadow-2xl"
            :class="notification.type === 'success' ? 'border-l-4 border-green-500' : 'border-l-4 border-red-500'">
            <div class="flex">
                <div class="flex-shrink-0">
                    <svg x-show="notification.type === 'success'" class="h-6 w-6 text-green-500" fill="currentColor"
                        viewBox="0 0 20 20">
                        <path fill-rule="evenodd"
                            d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z"
                            clip-rule="evenodd"></path>
                    </svg>
                    <svg x-show="notification.type === 'error'" class="h-6 w-6 text-red-500" fill="currentColor"
                        viewBox="0 0 20 20">
                        <path fill-rule="evenodd"
        ...
        function productsManager() {
            return {
                ...
                removeExistingImage(index) {
                    ...
                    // Mettre à jour les données locales de manière réactive
                    if (this.formData.images) {
                        let images = this.getImagesArray(this.formData.images);
                        images.splice(index, 1);

                        // Réindexer les images restantes pour maintenir la cohérence
                        images.forEach((img, i) => {
                            if (i === 0 && images.length > 0) {
                                img.is_main = img.is_main || !images.some(image => image.is_main);
                            }
                        });

                        this.formData.images = JSON.stringify(images);

                        // Forcer la réactivité d'Alpine.js
                        this.$nextTick(() => {
                ...
                refreshImages() {
                    if (this.formData.images) {
                        // Cloner l'objet pour déclencher la réactivité
                        const images = this.getImagesArray(this.formData.images);
                        this.formData.images = JSON.stringify([...images]);
                    }
                },
                ...
                async setMainImage(index) {
                    if (!this.isEditing || !this.formData.id) {
                        this.showNotification('error', 'Impossible de modifier l\'image principale');
                        return;
                    }

                    this.loading = true;
                    try {
                        const response = await this.makeRequest('set_main_image', {
                            id: this.formData.id,
                            image_index: index
                        });
                        ...
                        this.showNotification('error', 'Erreur lors de la mise à jour de l\'image principale');
                    } finally {
                        this.loading = false;
                    }
                },
                ...
                getImagesArray(images) {
                    if (!images || images === 'null' || images === '') return [];
                    try {
